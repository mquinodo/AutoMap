...
chr_position=c(124478211,370053186,590297730,784552788,970429194,1146601313,1311677289,1463919594,1605686270,1741782340,1876224362,2010405327,2134225146,2244929169,2349446622,2445611389,2532409282,2614224645,2683720096,2745250987,2800828062,2849592288)
chr_limits=c(0,248956422, 491149951, 689445510, 879660065, 1061198324, 1232004303, 1391350276, 1536488912, 1674883629, 1808681051, 1943767673, 2077042982, 2191407310, 2298451028, 2400442217, 2490780562, 2574038003, 2654411288, 2713028904, 2777473071, 2824183054, 2875001522)
...
plot(c(0,max(chr_limits)),c(0,100),xlim=c(1,max(chr_limits)), yaxs = "i", xaxs = "i",type="n",xlab="", ylab="",axes=F, main=paste("Common Homozygous Regions for ", patient, "\n Total = ",size," Mb (autosomes)", sep=""))
